...
#Adding Cryptography Modules and Initiating a Key as Variable f. - GT
from cryptography.fernet import Fernet
key = 'trtW_GH9qjysGMIZcZh76BnLn68FD0loUt7EdC_jK6M='
f = Fernet(key)
...
class GUI:
    ...
    def initialize_gui(self):  # GUI initializer
        self.root.title("Secure Messaging Chat") #Updated the name of the chat box - GT
    ...
    def send_chat(self):
        ...
        self.chat_transcript_area.yview(END)
        self.client_socket.send(f.encrypt(message))
        self.enter_text_widget.delete(1.0, 'end')
        return 'break'
